    ...
    post {
        success {
            script {
                ...
                echo "=========================================="
                echo "  环境信息    | ${s1}ms (${String.format('%.1f', s1/1000.0)}s)"
                echo "  拉取代码    | ${s2}ms (${String.format('%.1f', s2/1000.0)}s)"
                echo "  安装依赖    | ${s3}ms (${String.format('%.1f', s3/1000.0)}s)"
                echo "  构建项目    | ${s4}ms (${String.format('%.1f', s4/1000.0)}s)"
                echo "  部署        | ${s5}ms (${String.format('%.1f', s5/1000.0)}s)"
                echo "  验证部署    | ${s6}ms (${String.format('%.1f', s6/1000.0)}s)"
                echo "=========================================="
                echo "  阶段合计    | ${stageTotal}ms (${String.format('%.1f', stageTotal/1000.0)}s)"
                echo "=========================================="
